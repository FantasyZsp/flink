...
package org.apache.flink.connector.jdbc.yw.table;

import org.apache.flink.api.java.tuple.Tuple2;
import org.apache.flink.connector.jdbc.yw.dialect.JdbcDialects;
import org.apache.flink.connector.jdbc.yw.internal.options.JdbcLookupOptions;
import org.apache.flink.connector.jdbc.yw.internal.options.JdbcOptions;
import org.apache.flink.connector.jdbc.yw.internal.options.JdbcReadOptions;
import org.apache.flink.table.api.TableSchema;
import org.apache.flink.table.descriptors.DescriptorProperties;
import org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator;
...
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_CONNECTION_MAX_RETRY_TIMEOUT;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_DRIVER;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_LOOKUP_CACHE_MAX_ROWS;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_LOOKUP_CACHE_TTL;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_LOOKUP_MAX_RETRIES;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_PASSWORD;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_READ_FETCH_SIZE;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_READ_PARTITION_COLUMN;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_READ_PARTITION_LOWER_BOUND;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_READ_PARTITION_NUM;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_READ_PARTITION_UPPER_BOUND;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_READ_QUERY;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_TABLE;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_TYPE_VALUE_JDBC;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_URL;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_USERNAME;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_WRITE_FLUSH_INTERVAL;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_WRITE_FLUSH_MAX_ROWS;
import static org.apache.flink.connector.jdbc.yw.table.descriptors.JdbcValidator.CONNECTOR_WRITE_MAX_RETRIES;
